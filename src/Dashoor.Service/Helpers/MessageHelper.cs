...
namespace Dashoor.Service
{
    public static class MessageHelper
    {
        public static MessageReadStateService MessageReadStateService
        {
            get
            {
                return ContainerManager.GetConfiguredContainer().Resolve<Dashoor.Service.MessageReadStateService>();
            }
        }
        ...
        public static MessageService MessageService
        {
            get
            {
                return ContainerManager.GetConfiguredContainer().Resolve<Dashoor.Service.MessageService>();
            }
        }
        ...
        public static MessageThreadService MessageThreadService
        {
            get
            {
                return ContainerManager.GetConfiguredContainer().Resolve<Dashoor.Service.MessageThreadService>();
            }
        }
        ...
        public static MessageParticipantService MessageParticipantService
        {
            get
            {
                return ContainerManager.GetConfiguredContainer().Resolve<Dashoor.Service.MessageParticipantService>();
            }
        }
