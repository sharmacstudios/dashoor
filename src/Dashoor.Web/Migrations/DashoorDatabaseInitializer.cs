...
using System.IO;
using Dashoor.Core.Migrations;
using System.Globalization;

namespace Dashoor.Web.Migrations
{
    public class DashoorDatabaseInitializer : CreateAndMigrateDatabaseInitializer<Dashoor.Model.Models.DashoorContext, ConfigurationInstall<Dashoor.Model.Models.DashoorContext>>
    {
        ...
        public DashoorDatabaseInitializer(InstallModel installModel)
            : base()
        {
            _installModel = installModel;
            InitializeDatabase(new Model.Models.DashoorContext());
        }
        #endregion

        #region Methods
        protected override void Seed(Dashoor.Model.Models.DashoorContext context)
        {
        ...
        private void InstallSettings(Dashoor.Model.Models.DashoorContext context)
        {
            if (_installModel.InstallSampleData)
            {
                context.Settings.Add(new Model.Models.Setting()
                {
                    ...
                    Slogan = "Dashoor - Spa Demo",
                    SearchPlaceHolder = "Search your Spa...",
                    EmailContact = "hello@Dashoor.com",
                    Version = "1.0",
                    Currency = "DKK",
        ...
        private void InstallEmailTemplates(Dashoor.Model.Models.DashoorContext context)
        {
        ...
        private void InstallSampleData(Dashoor.Model.Models.DashoorContext context, ApplicationUser user)
        {
