...
namespace Dashoor.Web.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        {
            container
                .RegisterType<IDataContextAsync, DashoorContext>(new PerRequestLifetimeManager())
                ...
                .RegisterType<IStoredProcedures, DashoorContext>(new PerRequestLifetimeManager())
